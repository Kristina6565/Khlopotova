#Задание 2
#Выполнила Хлопотова К.М. 124 ПАЭ группа
#создайте модель множественной линейной регрессии ночных потоков паров воды за летний период 2013 года по данным измерений методом турбулетной пульсации
#зададим и проверим директорию 
setwd("D:/Khlopotova/mathmod2") 
getwd()
